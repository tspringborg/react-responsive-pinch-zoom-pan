...
function (_React$Component) {
  ...
  function PinchZoomPan() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleTouchEnd", function (event) {
      ...
      if (event.touches.length === 0 && event.changedTouches.length === 1) {
        if (_this.lastPointerUpTimeStamp && _this.lastPointerUpTimeStamp + DOUBLE_TAP_THRESHOLD > event.timeStamp) {
          var pointerPosition = (0, _Utils.getRelativePosition)(event.changedTouches[0], _this.contentRef.parentNode);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMouseDoubleClick", function (event) {
      ...
      var pointerPosition = (0, _Utils.getRelativePosition)(event, _this.contentRef.parentNode);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMouseWheel", function (event) {
      ...
      var point = (0, _Utils.getRelativePosition)(event, _this.contentRef.parentNode);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleContentRef", function (ref) {
      if (_this.contentRef) {
        ...
        _this.contentRef.removeEventListener('touchmove', _this.handleTouchMove);
      }

      _this.contentRef = ref;

      if (ref) {
        _this.contentRef.addEventListener('touchmove', _this.handleTouchMove, {
          passive: false
        });
      }

      var _React$Children$only2 = _react.default.Children.only(_this.props.children),
          contentRefProp = _React$Children$only2.ref;

      (0, _Utils.setRef)(contentRefProp, ref);
    });
  ...
  _createClass(PinchZoomPan, [{
    ...
    value: function pointerDown(clientPosition) {
      this.lastPanPointerPosition = (0, _Utils.getRelativePosition)(clientPosition, this.contentRef.parentNode);
    }
  }, {
    key: "pan",
    value: function pan(pointerClientPosition) {
      ...
      var pointerPosition = (0, _Utils.getRelativePosition)(pointerClientPosition, this.contentRef.parentNode);
    ...
    value: function maybeHandleDimensionsChanged() {
      ...
      if (this.isImageReady) {
        var containerDimensions = (0, _Utils.getContainerDimensions)(this.contentRef);
        var imageDimensions = (0, _Utils.getDimensions)(this.contentRef);
